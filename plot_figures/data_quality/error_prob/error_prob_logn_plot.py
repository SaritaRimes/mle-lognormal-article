...
# Importing the data
error_logn = import_error_data_quality_separately_crossvalidation(occupancy, iteration, number_iterations, method)
prob_logn = import_prob_data_quality_separately_crossvalidation(occupancy, iteration, number_iterations, method)
...
plt.scatter(error_logn, prob_logn, color=ap['color_logn'], s=2, zorder=3)
