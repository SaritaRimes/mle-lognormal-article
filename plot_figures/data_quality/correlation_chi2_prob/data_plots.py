def return_data_plots(dq_method, reconstruction_method):
    ...
    if dq_method == 'chi2':
        ...
        if reconstruction_method == 'all':
            y_limit = [-0.5, 0.5625]  # without absolute value
            y_axis_arguments = {'plot_step': 0.25, 'y_plus': 0}  # without absolute value
            # y_limit = [-0.45, 0.45]
        ...
        if reconstruction_method == 'mle_gaussiano':
            ...
            y_limit = [-0.1, 0.075]  # without absolute value
            y_axis_arguments = {'plot_step': 0.05, 'y_plus': 0}  # without absolute value
            # y_limit = [0, 0.1275]
