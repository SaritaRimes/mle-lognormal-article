...
chi2_cof = import_chi2_data_quality_separately_crossvalidation(occupancy, iteration, number_iterations, method)
...
plt.scatter(error_cof, chi2_cof, color=ap['color_cof'], s=2, zorder=3)
