...
def configure_x_axis(data_x, data_y, original_axis, copy_axis, dist_color, dist_style, label_dist, x_limit, y_limit,
                     x_axis_arguments):
    copy_axis.plot(data_x, data_y, color=dist_color, ls=dist_style, label=label_dist, lw=2, zorder=3)
...
def configure_y_axis(data_x, data_y, original_axis, copy_axis, dist_color, dist_style, label_dist, x_limit, y_limit,
                     y_axis_arguments):
    copy_axis.plot(data_x, data_y, color=dist_color, ls=dist_style, label=label_dist, lw=2, zorder=3)
